var motion = {
	...
	bounceIn: function(t, b, c, d){
		return c - motion['bounceOut'](d-t, 0, c, d) + b;
	},       
	...
	bounceBoth: function(t, b, c, d){
		if (t < d/2) {
			return motion['bounceIn'](t*2, 0, c, d) * 0.5 + b;
		}
		return motion['bounceOut'](t*2-d, 0, c, d) * 0.5 + c*0.5 + b;
	}
};
	...
	init.el.timer = setInterval(
		function(){
			...
			if(t>d){
				...
				for(var s in b){
					var val = Number((motion[init.type](t,b[s],c[s],d)).toFixed(2));
					css(init.el, s, val);
				}
			}
		},
